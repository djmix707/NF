...
# ==================== IMPROVED EXTRACTION FROM REACT CONTEXT ====================

def extract_from_react_context(html_content):
    """استخراج البيانات من netflix.reactContext JSON - الطريقة الصحيحة"""
    info = {}
    ...
    if match:
        try:
            ...
            # 3. استخراج من signupContext (مصدر الباقة والسعر)
            ...
            # 5. استخراج من contentRestrictions
    ...
    # استخراج الباقة من HTML إذا لم توجد
...
# ==================== ORIGINAL WORKING PLAN FUNCTIONS ====================
